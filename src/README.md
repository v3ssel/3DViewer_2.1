...
Created with Qt6 + OpenGL, QGifImage is taken from [here](https://github.com/dbzhang800/QtGifImage)

## Dependencies
1. Qt6 + QtOpenGLWidgets + OpenGL 2.0
2. C++17
3. make and cmake
...
2. cd to src folder
3. Type `make install`
4. Type `open 3DViewer.app` or open app from icon.
...
* To change the projection type, go to Settings -> Orthographic/Perspective, then the projection type will be changed to opposite.
